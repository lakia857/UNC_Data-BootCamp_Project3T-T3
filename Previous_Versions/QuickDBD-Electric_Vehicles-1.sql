...
ALTER TABLE cleaned_ev_stations DROP CONSTRAINT fk_cleaned_ev_stations_region;

ALTER TABLE ev_sales DROP CONSTRAINT fk_ev_sales_year;

--SELECT *
--FROM "cleaned_ev_stations";

--DROP TABLE "cleaned_ev_stations";
